"""Regression checks for the zenith-sec-rules-index casebook."""
...
from casebook.harness import assert_expected, zenith_sec_rules_index_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(zenith_sec_rules_index_summary(), assert_expected())
