...
`zenith-sec-rules-index` is centered on security tooling work in PHP. The technical target is: Implement a PHP security tooling project for rules resource planning, using capacity fixtures and allocation and spill reports.
...
The score is deterministic. The current threshold is 152. Risk has a penalty of 7, latency has a penalty of 2, and weight contributes a bonus of 2.
